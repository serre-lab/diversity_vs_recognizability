...
from .likelihood import select_likelihood
...
class BaseModel(nn.Module):
    ...
    def step(
        ...
        loss_dict = self.loss(outputs, weight=(alpha + 1), free_bits=free_bits, beta = beta)
        loss = loss_dict["loss"]
        loss_dict["mse"] = outputs["mse"]
        loss_dict["xp"] = outputs["xp"]
        loss_dict["x_rec"] = outputs["x_rec"]
