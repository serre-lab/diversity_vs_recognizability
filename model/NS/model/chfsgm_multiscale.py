...
from .layer.layers_multi_scale import (DecBlockC, DecBlockZ, Encoder,
                                            ObservationDec)
...
class CHFSGM_MULTISCALE(CHFSGM):
    ...
    def loss(
        self, out: dict, weight: float = 1.0, beta = 1.0, free_bits: bool = False
    ...
    def generate(self, n_samples, exemplar=None, limit_layer=None, t=None):
        """
        Sample the model given a context X.
        Sample are obtained in one-shot
        using the approximate posterior over c
