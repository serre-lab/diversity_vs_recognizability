...
def dataset_kwargs(args):
    kwargs = {
        "omniglot": {"size": 50, "nc": 1},
        "omniglot_back_eval": {"size":50, "nc": 1},
        "omniglot_random": {"size":50, "nc": 1},
        "mnist": {"size":50, "nc": 1},
        "doublemnist": {"size":50, "nc": 1},
        "triplemnist": {"size":50, "nc": 1},
